class CategoriesController < ApplicationController
  ...
  # RECOVERY /categories/1
  # RECOVERY /categories/1.json
  def recovery   
    # 标记恢复品类，并对该品类下的所有产品标记已恢复
    ...
    respond_to do |format|
      format.html { redirect_to categories_url, notice: 'Category was successfully recoveryed.' }
      format.json { head :no_content }
    end
  end
