...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { is_del: @station.is_del, name: @station.name } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { is_del: @station.is_del, name: @station.name } }
